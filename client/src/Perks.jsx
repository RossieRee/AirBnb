export default function Perks({selected, onChange}) { //selected = currently selected list, onChange = new List
    function handleCbClick(ev) {
        const {checked, name} = ev.target //ev.target.name: name="" //ev.target.checked: boolean
        if (checked) {
        ...
        <>
            <div className="grid mt-2 gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
                <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                    <input type="checkbox" checked={selected.includes("wi-fi")} name="wi-fi" onChange={handleCbClick}/>
